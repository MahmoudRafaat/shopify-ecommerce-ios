...
protocol CollectionServiceProtocol {
    func loadProducts(collectionId: Int, searchQuery: String?) async throws -> (products: [ProductDTO], nextPageURL: URL?)
...
class CollectionService: CollectionServiceProtocol {
    ...
    func loadProducts(collectionId: Int, searchQuery: String?) async throws -> (products: [ProductDTO], nextPageURL: URL?) {
        let endpoint = CollectionEndPoints.collectionProducts(collectionId: collectionId, searchQuery: searchQuery)
